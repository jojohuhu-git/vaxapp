...
export const RULES_REGISTRY = {
  ...
  'MenACWY.interval': { description: 'High risk: minimum 8 weeks between doses 1 and 2 from age 2 years; 8 weeks within the infant series; 12 weeks and past the first birthday if the series started at 7–23 months', citation: REFS.acip2020HighRiskPrimary },
  // MenB
